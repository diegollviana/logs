        ...
        <tr>
        	<td style="padding:15px 20px 5px 20px;">
            	<table cellspacing="0" cellpadding="0" border="0" style="border-collapse:collapse;width:100%">
                	<tr>
                    	<td><a href="#" style="text-decoration:none; font-size:14px; color:#5989C6; font-weight:bold;">Ol&aacute; {username}!</a></td>
                    </tr>
                    <tr>
                    	<td>
                        	<p style="margin:0px; padding:5px 0px;">
                            	estamos reenviando para voc&ecirc; o email para confirma&ccedil;&atilde;o do cadastro!<br />
                            ...
                            <p style="margin:0px; padding:5px 0px;">
                            	<a href="{url_site}confirmacao_cadastro.php?cc={chave_cadastro}&email={email}&usr={username}" style="display: inline-block; line-height: 13px; /* IE8 hack */ line-height: 16px\0/; border-width: 0px; font-size: 12px; font-family: arial; color: #FFFFFF; font-weight: bold; cursor: pointer; padding: 7px 10px; -moz-border-radius: 3px 3px 3px 3px; -webkit-border-radius: 3px 3px 3px 3px; border-radius: 3px 3px 3px 3px; background-color: #67A54B; border:1px solid #52853D; text-decoration:none;">Confirmar que recebi este email</a>
                            </p>
